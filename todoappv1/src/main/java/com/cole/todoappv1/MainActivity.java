...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateView() {
        ...
        for (Task task : taskList) {
            ...
            TextView deadlineField = new TextView(this);
            deadlineField.setText(task.getDeadlineString());
            deadlineField.setId( 10 * task.getId()+2);

            if (task.getDeadline().before(new Date())) {
                idView.setBackgroundColor(getResources().getColor(R.color.red));
                titleField.setBackgroundColor(getResources().getColor(R.color.red));
                descField.setBackgroundColor(getResources().getColor(R.color.red));
                deadlineField.setBackgroundColor(getResources().getColor(R.color.red));
            }
