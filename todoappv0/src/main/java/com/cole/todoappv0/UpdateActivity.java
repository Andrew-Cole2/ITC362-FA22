...
//            emailField.setId( 10 * task.getId()+2);
            ...
            grid.addView(lNameField, (int) (width * .4), ViewGroup.LayoutParams.WRAP_CONTENT);
//            grid.addView(deadlineField, (int) (width * .35), ViewGroup.LayoutParams.WRAP_CONTENT);
...
//            EditText deadlineField = (EditText) findViewById(10*id+2);
            String newfName = titleField.getText().toString();
            String newlName = descField.getText().toString();
//            String newEmail = deadlineField.getText().toString();
            try {
                dbManager.updateById(id, newfName, newlName);
            } catch (Exception e) {
